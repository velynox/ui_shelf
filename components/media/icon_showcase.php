<?php
// A curated set of Heroicons (outline) rendered as inline SVGs.
$icons = [
    ...
    ['name' => 'code',       'path' => 'M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5'],
    ['name' => 'terminal',   'path' => 'M6.75 7.5l3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0021 18V6a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 6v12a2.25 2.25 0 002.25 2.25z'],
    ['name' => 'folder',     'path' => 'M2.25 12.75V12A2.25 2.25 0 014.5 9.75h15A2.25 2.25 0 0121.75 12v.75m-8.69-6.44l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06-.44z'],
    ['name' => 'star',       'path' => 'M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z'],
    ...
    ['name' => 'x-mark',     'path' => 'M6 18L18 6M6 6l12 12'],
];
?>

<div class="flex flex-wrap gap-2 max-w-sm">
    <?php foreach ($icons as $icon): ?>
    <div class="group flex flex-col items-center gap-1.5 p-2.5 rounded-lg
                border border-[#313244] bg-[#181825] w-16
                hover:border-[#cba6f7]/40 hover:bg-[#cba6f7]/5
                transition-colors duration-150 cursor-default">
        <svg xmlns="http://www.w3.org/2000/svg"
             class="w-5 h-5 text-[#a6adc8] group-hover:text-[#cba6f7]
                    transition-colors duration-150"
             fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round"
                  d="<?= htmlspecialchars($icon['path']) ?>"/>
        </svg>
        <span class="text-[#45475a] text-[9px] text-center leading-tight group-hover:text-[#585b70]
                     transition-colors duration-150">
